...
# ==========================================
st.markdown("""<style>
    .ych-card { background-color: #FFFFFF; border-radius: 8px; padding: 18px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border-left: 5px solid #003366; margin-bottom: 15px; height: 130px; }
    .ych-kpi-val { font-size: 28px; font-weight: bold; color: #003366; }
    .ych-action-btn { width: 100%; height: 42px; border: none; border-radius: 4px; color: white; font-weight: bold; font-size: 12px; cursor: pointer; display: flex; align-items: center; justify-content: center; text-decoration: none; }
...
if st.session_state["change_pwd"]:
    st.warning("⚠️ Please update your default password.")
...
# ==========================================
# MAIN APP FLOW (Admin vs Employee)
# ==========================================
# (Place your existing logic here, ensuring the Employee view only accesses their own ID)
# ... [Use the previous logic provided in the last step for the dashboards] ...
# Make sure to filter queries by: WHERE employee_id = '{st.session_state['username']}' for Employees.
