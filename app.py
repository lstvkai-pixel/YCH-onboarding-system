                    ...
                    if f_path and os.path.exists(f_path):
                        ...
                        with st.expander(f"👁️ Open and Read: {title}"):
                            if file_ext in ['png', 'jpg', 'jpeg']:
                                ...
                                # Highly secure IFRAME method to bypass Streamlit blocks
                                pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}#toolbar=0&navpanes=0" width="100%" height="700" style="border:none;"></iframe>'
